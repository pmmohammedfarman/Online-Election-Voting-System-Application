...
public class MessageFromCandidateToAdminForVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef2 =  FirebaseDatabase.getInstance().getReference("Candidate");
        ...
        Send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification.this, "Please Enter a message to send", Toast.LENGTH_SHORT).show();
                }
                ...
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification.this, "Can", Toast.LENGTH_SHORT).show();

                }
                else
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification.this, "C", Toast.LENGTH_SHORT).show();
                }

                MessageFromCandidateToAdminForVerification.super.finish();
            }
        });
    ...
    private void lol() {
        mRef4.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                System.out.println(new_mailID+"   "+me+"");
            }
    ...
    private void sendmessage(String maills,String candidate_ID, String recipientList, String messageSubject, String message) {
        Query checkUser = mRef.orderByChild("Admin_ID").equalTo(recipientList);
