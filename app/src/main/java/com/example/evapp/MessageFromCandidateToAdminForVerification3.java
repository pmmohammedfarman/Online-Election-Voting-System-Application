...
public class MessageFromCandidateToAdminForVerification3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification3.this, "Please Enter a message to send", Toast.LENGTH_SHORT).show();
                }
                ...
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification3.this, "Can", Toast.LENGTH_SHORT).show();

                }
                else
                {
                    Toast.makeText(MessageFromCandidateToAdminForVerification3.this, "C", Toast.LENGTH_SHORT).show();
                }

                MessageFromCandidateToAdminForVerification3.super.finish();
            }
        });
