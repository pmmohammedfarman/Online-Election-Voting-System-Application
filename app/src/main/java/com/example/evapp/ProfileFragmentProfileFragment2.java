...
public class ProfileFragmentProfileFragment2 extends Fragment {
   ...
   // Button Logout,AdminPortal;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adhaar_ID = getArguments().getString("adhaar_ID");
        ...
        System.out.println(""+adhaar_ID+"jjjjjj");
      ...
      //  Query checkUser = mRef.orderByChild("adhaar_Id").equalTo(adhaar_ID);
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        String name = snapshot.child("Users").child("0001").child("name").getValue(String.class);
                        System.out.println(""+name+"jjjjjj");
                        myArrayList.add(name);
                        myArrayAdapter.notifyDataSetChanged();
                        String dob = snapshot.child("Users").child("0001").child("DOB").getValue(String.class);
                        myArrayList2.add(dob + "");
                        myArrayAdapter2.notifyDataSetChanged();
                        String constituency = snapshot.child("Users").child("0001").child("Constituency").getValue(String.class);
                        ...
                        String phone = snapshot.child("Users").child("0001").child("phone").getValue(String.class);

                        myArrayList4.add(phone);
                        myArrayAdapter4.notifyDataSetChanged();
    ...
    public  boolean onOptionsItemSelected(@NonNull MenuItem menuItem)
    {
        ...
        switch (id){
            ...
            case R.id.EditProfile:
                ...
                gameData.putString("adhaar_ID",adhaar_ID);
